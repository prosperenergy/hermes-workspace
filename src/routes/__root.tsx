  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: 'description',
        content:
          'PROSPER OS command cockpit for agents, models, tools, files, memory, and jobs.',
      },
      {
        property: 'og:image',
        content: '/cover.png',
      ...
      <body>
        ...
        <script
          ...
          (function(){
            ...
            var quips = ["Loading Prosper OS...","Checking agent lanes...","Warming up the model gateway...","Preparing the command cockpit...","Checking live tools...","Opening the workspace..."];
            ...
            d.innerHTML = '<img src="/logo-icon.png" alt="PROSPER OS" style="width:80px;height:80px;margin-bottom:20px;border-radius:16px;filter:drop-shadow(0 8px 32px color-mix(in srgb,'+accent+' 45%, transparent))" />'
              + '<div style="font:800 34px/1 system-ui,-apple-system,sans-serif;letter-spacing:0;color:'+txt+'">PROSPER OS</div>'
              + '<div style="margin-top:8px;font:500 13px/1 system-ui,-apple-system,sans-serif;letter-spacing:0.08em;text-transform:uppercase;color:'+muted+'">Command Cockpit</div>'
